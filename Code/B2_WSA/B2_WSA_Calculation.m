...
% s(4) = The input for WSA in the first 0-14 days [4.89,7];
s=[8.0 0.07409079796009843 0.22600136198889834 5.213323955218834];
data=[0 0.022 0.021 0.038 0.022]; % Input actual measured water use WSB for Office Building B2_WSA
...
f=@(t,y,Z)[(B2_WSA_a1(t)-y(1));
    s(2).*(B2_WSA_a2(t,s(4))-y(2));
    (B2_WSA_a3(t)-y(3));
    (B2_WSA_a4(t)-y(4));
