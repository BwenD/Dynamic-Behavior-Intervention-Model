...
clc;
% Input parameters
% s(1) = Time lag from SN to WSI [1,14]; s(2) = The reciprocal of the inventory time coefficient for SN [0,1];
% s(3) = The reciprocal of the inventory time coefficient for WSI [0,1]; s(4) = The input for SN in the first 0-14 days [4.3,7];
s=[11.0 0.39014066655415985 0.7471218294009637 6.134494609216256];
...
xlabel('Time t');
ylabel('Solution y');
legend('SN','WSA','SE','PBC','WSI','Location','NorthWest'); % Legend for the plot
