...
s=[5.0 0.17584506605448333 0.15135036651421396 6.547920271611643];
...
Mu=corrcoef(mubiao_y,scy_w); % Objective function as the correlation coefficient (Pearson), an alternative to Euclidean distance
W=-Mu(1,2); % The objective function value as the negative of the correlation coefficient
